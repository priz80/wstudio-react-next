        ...
        <div className="container">
          ...
          <div className="content">
            <div className="menu-container">
              ...
              <img src="/img/header_img/logo.svg" className="logo-mobile" alt="logo" />
              <div className="menu">
                {/* Бургер-иконка */}
                <div
                ...
                <nav onClick={() => setIsMenuOpen(false)} className={`nav-menu ${isMenuOpen ? "active" : ""}`}>
                  <ul>
                    <li><a href="/" onClick={() => setIsMenuOpen(false)}>Главная</a></li>
                    <li><a href="/" onClick={() => setIsMenuOpen(false)}>Почему именно мы?</a></li>
                    <li className="mobile-only"><a href="/" onClick={() => setIsMenuOpen(false)}>Портфолио</a></li>
                    <li><a href="/" onClick={() => setIsMenuOpen(false)}>Контакты</a></li>
                    <li className="mobile-only"><a href="/" onClick={() => setIsMenuOpen(false)}>Оставить заявку</a></li>
                  </ul>
                </nav>
