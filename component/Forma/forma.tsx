...
import "./forma.module.scss";

export const Forma = () => {
  return (
    <div className="container forma-container" id="forma">
      <div className="content">
        <div className="title-forma"><h5>Оставь заявку</h5></div>
        <form action="" className="foma-block">
          ...
          {/* Бюджет */}
          <div className="forma-item-wrapper">
            <label htmlFor="budget" className="input-label">Бюджет на сайт</label>
            <input
              type="text"
              id="budget"
              name="budget"
          ...
          {/* Email */}
          <div className="forma-item-wrapper">
            <label htmlFor="email" className="input-label">E-MAIL адрес</label>
            <input
              type="email"
              id="email"
              name="email"
          ...
          {/* Комментарий */}
          <div className="forma-item-wrapper">
            <label htmlFor="comment" className="input-label">Комментарий (по желанию)</label>
            <input
              type="text"
              id="comment"
              name="comment"
